<div class="p-5 list-group">
    <h1 class="display-5 text-start">Friends</h1>
    <a class="list-group-item list-group-item-action" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="border rounded-circle">
